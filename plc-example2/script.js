/* ============================================================
   지멘스 PLC 기초강좌 - PLC 예제② 타이머·카운터
   ⚠️ 저장소 독립성: 이 프로젝트의 모든 localStorage 키는
   반드시 STORAGE_PREFIX('plc_example2_')로 시작합니다.
...
============================================================ */
var STORAGE_PREFIX = 'plc_example2_';
...
async function exportUserData() {
    // 백업 데이터에는 이 프로젝트(plc_example2_) 소유 데이터만 포함합니다.
...
function importUserData(event) {
    ...
    reader.onload = function (e) {
        try {
            ...
            // 복원도 plc_example2_ 네임스페이스 안에서만 수행 (다른 프로젝트 데이터 건드리지 않음)
...
// plc_example2_ 로 시작하는 이 프로젝트 소유 키만 선별 삭제합니다.
