/* ============================================================
   지멘스 PLC 기초강좌 - PLC 사용법
   ⚠️ 저장소 독립성: 이 프로젝트의 모든 localStorage 키는
   반드시 STORAGE_PREFIX('plc_usage_')로 시작합니다.
...
function checkDailyNotify() {
    ...
    if (lastNotifyDate !== today) {
        ...
        new Notification('지멘스 PLC 기초강좌 - PLC 사용법 🛠️', {
...
async function exportUserData() {
    // 백업 데이터에는 이 프로젝트(plc_usage_) 소유 데이터만 포함합니다.
...
function importUserData(event) {
    ...
    reader.onload = function (e) {
        try {
            ...
            // 복원도 plc_usage_ 네임스페이스 안에서만 수행 (다른 프로젝트 데이터 건드리지 않음)
...
// plc_usage_ 로 시작하는 이 프로젝트 소유 키만 선별 삭제합니다.
...
/* ===================== 퀴즈 채점 ===================== */
var unitTitles = {
    1: "01. TIA Portal이란?", 2: "02. 설치와 라이선스 개요", 3: "03. Portal 뷰 vs 프로젝트 뷰", 4: "04. 화면 구성 상세", 5: "05. 새 프로젝트 만들기 & 디바이스 추가", 6: "06. 프로그램 블록의 종류 (OB/FC/FB/DB)", 7: "07. 컴파일·다운로드·모니터링", 8: "08. 프로젝트 관리와 팀 협업"
};
